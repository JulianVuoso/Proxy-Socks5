...
START_TEST (test_selector_register_fd) {
    ...
    ck_assert_uint_eq(SELECTOR_IARGS,   selector_register(0, -1, 0, 0, data_mark, GEN_TIMEOUT));
    ...
    ck_assert_uint_eq(SELECTOR_SUCCESS,
                      selector_register(s, fd, &h, 0, data_mark, GEN_TIMEOUT));
